        ...
        <form method="POST" action="addPost.php">
            <fieldset>
                ...
                <section class="form-group">
                    ...
                    <input type="text" id="blog-title" name="title" placeholder="Enter blog title" value="<?php echo isset($_GET['Title']) ? $_GET['Title'] : ''; ?>">
                </section>
    
                <section class="form-group">
                    <label for="blog-content">Enter your text here</label>
                    <textarea id="blog-content" name="content" rows="6" placeholder="Write your blog content..."><?php echo isset($_GET['Content']) ? htmlspecialchars($_GET['Content']) : ''; ?></textarea>
                </section>
